...
を確認する。詳細は [`topics/ai-native-startup-lifecycle.md`](../topics/ai-native-startup-lifecycle.md) Idea 段階を参照。
...
リポのルートに `CLAUDE.md` を作り、Claude Code セッション開始時に自動で読まれる**永続メモリ**として使う。書き方の詳細は [`write-effective-claude-md.md`](./write-effective-claude-md.md) に分離。最低限載せるもの:
...
- [`write-effective-claude-md.md`](./write-effective-claude-md.md) — `CLAUDE.md` の中身の書き方
- [`ingest-source-from-web.md`](./ingest-source-from-web.md) — 学んだ知見をこのリポに取り込む手順
- [`frameworks/anthropic-claude-code.md`](../frameworks/anthropic-claude-code.md) — サーフェス選択・HTML 出力指針
- [`topics/ai-native-startup-lifecycle.md`](../topics/ai-native-startup-lifecycle.md) — どの段階で何を優先するか
